...
?>
	...
	<form method="post" action="td_add_post.php">
		...
		<div class="box">
			<table cellpadding="0" cellspacing="0" border="0">
				...
				foreach ( $view_td as $row ) {
					echo "<tr>
					<td><input type='text' class='form-control' name='title[]' placeholder='题目类别名称' value='$row[0]'>
					</td>
					<td><input type='text' class='form-control' name='num[]' placeholder='输入编号' value='$row[1]'>
					</td>
		...
		<button type="submit" class="btn btn-success">提交题单数据</button>
	</form>
