...
<li>
    ...
    <a class='btn btn-primary' href="homework_add.php" target="main"><b><?php echo "添加作业"?></b></a>
<?php }
if (isset($_SESSION['administrator'])||isset($_SESSION['contest_creator'])){
?>
<li>
	<a class='btn btn-primary' href="contest_list.php" target="main"><b><?php echo $MSG_CONTEST.$MSG_LIST?></b></a>
    <a class='btn btn-primary' href="homework_list.php" target="main"><b><?php echo "作业列表"?></b></a>
	
	<!--题单功能 add by hxh 201909--><br>
	<a class='btn btn-success' href="td_list.php" target="main"><b><?php echo "题单列表"?></b></a>
	<a class='btn btn-success' href="td_add.php" target="main"><b><?php echo "新建题单"?></b></a>
