...
<div class="container">
  ...
  <div class="jumbotron">
        ...
        <tr>
          <td  colspan=3 align=left><form class="form-inline" action=userinfo.php>
              ...
              if ( isset( $_SESSION[ 'administrator' ] ) )
                echo "  <a href='ranklist1.php'  class='btn btn-default'>显示姓名</a>";
              ?>
            </form></td>
          <td colspan=3 align=right><a href=ranklist1.php?scope=d>Day</a> <a href=ranklist1.php?scope=w>Week</a> <a href=ranklist1.php?scope=m>Month</a> <a href=ranklist1.php?scope=y>Year</a></td>
        </tr>
        <tr class='toprow'>
    ...
    for ( $i = 0; $i < $view_total; $i += $page_size ) {
      echo "<a href='./ranklist1.php?start=" . strval( $i ) . ( $scope ? "&scope=$scope" : "" ) . "'>";
      echo strval( $i + 1 );
      echo "-";
