      ...
      <tr>
        <td><table id='statics' >
            ...
            <tr id=pie bgcolor=white>
              <td colspan=2><div id='PieDiv' style='position:relative;height:150px;width:200px;'></div>
            </tr>
          </table>
          <br>
          ...
          <table id=recommand >
            <tr>
              <td> Recommanded Next Problem<br>
                <?php
                $cnt = 1;
          ...
          <?php }?></td>
        <td><table id=problemstatus>
            <thead>
              <tr class=toprow>
                <th style="cursor:hand" onclick="sortTable('problemstatus', 0, 'int');"><?php echo $MSG_Number?> 
                <th>RunID
