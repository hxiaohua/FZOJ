...
header("Pragma: no-cache");
	...
	$profile='';
		if (isset($_SESSION['user_id'])){
				...
				$profile.="&nbsp;<li><a href='".$path_fix."plus/add_solution_record.php'>增加新题解</a></li>";
        		$profile.="&nbsp;<li><a href='".$path_fix."plus/c_show_solution_record.php?user_id=".$_SESSION['user_id']."'>我的题解记录</a></li>";
