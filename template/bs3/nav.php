      ...
      <nav class="navbar navbar-default" role="navigation" >
        <div class="container-fluid">
	      ...
	      <li <?php if ($url=="faqs.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>faqs.php"><?php echo $MSG_FAQ?></a></li>
              ...
              <!--作业和题单 add by hxh-->
             <li <?php if ($url=="td.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>td.php">题单</a></li> 
               <li <?php if ($url=="homework.php") echo " $ACTIVE";?>><a href="<?php echo $path_fix?>homework.php"><?php echo $MSG_HOMEWORK?></a></li>
