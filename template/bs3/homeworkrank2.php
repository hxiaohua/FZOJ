...
$rank=1;
?>
<center><h3>homework RankList -- <?php echo $title?></h3><a href="homeworkrank.xls.php?hid=<?php echo $hid?>" >Download</a></center>
...
<?php
for ($i=0;$i<$pid_cnt;$i++)
echo "<td><a href=problem.php?hid=$hid&pid=$i>$PID[$i]</a></td>";
echo "</tr></thead>\n<tbody>";
