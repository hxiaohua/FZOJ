...
<li class="page-item">
	<a href="homework.php?page=1">&lt;&lt;</a></li>
<?php
...
for ($i=$start;$i<=$end;$i++){
 echo "<li class='".($page==$i?"active ":"")."page-item'>
        <a href='homework.php?page=".$i."'>".$i."</a></li>";
}
?>
<li class="page-item"><a href="homework.php?page=<?php echo $view_total_page?>">&gt;&gt;</a></li>
</ul>
	</nav>
