...
<script src="plus/template/bs3/profile.php?26611" ></script>
	  ...
	  -->
			...
			<br><br>
	  <h2 align="center">添加题目类别</h2>
	  <form method="post">
  <div class="form-group">
    <label>某类题目标题</label>
    <input type="text" class="form-control" name="title" placeholder="某类题目标题">
  </div>
  
    <div class="form-group">
    <label>题号(逗号隔开)</label>
    <input type="text" class="form-control" name="num_str" placeholder="题号(逗号隔开)">
  </div>
